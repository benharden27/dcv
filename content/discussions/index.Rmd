...
The small group discussions you will be doing for many modules' level 3 work are intended to give you a space to probe a series of questions as a small group of 3 or 4. 
...
After the discussion you will be asked to reflect on your preparedness and participation in the seminar and set a goal for the next discussion. This will be in the standard "Level Complete" form.

## Scoring

Level discussions will be scored 0-8 for final grade contribution. This score will be split equally between your demonstration of understanding and your participation in the discussion.

```{r, echo = FALSE}
knitr::kable(
  tibble::tribble(~"Score", ~"Understanding",~"Participation",
                  "0", "Absent or silent","Absent or silent",
                  "1", "Offered limited foundational ideas","Contributed in limited manner",
                  "2", "Demonstrated application of Level 1 and 2 ideas","Offered thoughts and asked questions",
                  "3", "Analysis in relation to Level 3 reading","Brought others into conversation through helpful questions",
                  "4"," Detailed analysis and evaluation","Helped guide conversation through synthesis, summaries and clarification questions"))
```