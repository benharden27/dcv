...
OK, so this question needs it's own post...

## Prerequisites

This will be a walk through of how to plot data on a map. We'll be using the [S225 hourly](S225_hourly.csv) location data to plot a cruise track.
