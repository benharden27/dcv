...
* Adding vertical light gray grid lines to guide the eye in interpreting the location of each feature in space and also comparing between properties.
...
* The vertical stacking allows for easier viewing, but does begin to make the figure quite long vertically. This might be hard to fit in a paper especially if we need to add more panels. There's a compromise to this method between the aspect ratio of the individual panels and the aspect ratio of the complete figure
