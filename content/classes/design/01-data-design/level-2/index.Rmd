...
It's time for you to give this a go and follow the example I laid out about. You should:

* Find a figure in a paper that you have been reading that you think could use some improvements.

* Print this figure out on a sheet of paper and list around it:
  * The design feature you like (so we don't get rid of the good as well as the bad)
  * Any design limitations of the figure
  
* On a new sheet of paper you should then redesign the figure. Make a sketch of your improved design (rough is fine as long as the features you have improves are clearly shown) and then make a list of:
  * The ways you improved the figure
  * The lingering questions/limitations you still have.

* Post these two pieces of paper next to each other in the classroom. 
