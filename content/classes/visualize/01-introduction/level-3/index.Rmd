...
If you've used Excel before, you'll be pretty familiar with the spreadsheet layout of data where we have rows and columns. The datasets you'll be working with in R are also organized in the same way (although this is not the only way R organizes data). R calls them data frames.
