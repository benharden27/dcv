...
Once you've created your account, click [this link](https://rstudio.cloud/spaces/170089/join?access_code=pZrXTmlGPgt7MivGd1TOmfKd%2BgWlet6PkZWAGlRN) to be added to my RStudio Cloud Classroom. You can move on to [level 2](../level-2/) once you've been added to the classroom.
...
* Get added to the [RStudio Cloud Classroom](https://rstudio.cloud/spaces/170089/join?access_code=pZrXTmlGPgt7MivGd1TOmfKd%2BgWlet6PkZWAGlRN)
* Submit an [Exit Ticket](https://docs.google.com/forms/d/e/1FAIpQLSdPtiT0QCRsZeBp1R2-vMiOPLa5lO6RI2F4ZrLuBNtlN7Nnkg/viewform?usp=sf_link)
