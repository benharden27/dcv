...
* Go find yourself a short radio script about the environment (probably around 4-5 min story). If you are struggling to find one, head over to NPR and almost all their stories are there with the transcript of the story.
...
* Note the effective strategies and also the ineffective ones, both for writing for voice and also writing for communicating the environment. For the ineffective strategies, you should offer a potential alternative method.
